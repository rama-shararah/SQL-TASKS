...
namespace task2.Account
{
    public partial class Register : Page
    {
        protected void CreateUser_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            SqlCommand email = new SqlCommand($"select id from AspNetUsers where Email='{Email.Text}'", Con);
            string userID = email.ExecuteScalar().ToString();
            string query = $"insert into AspNetUserRoles values('{userID}',{RadioButtonList1.SelectedValue})";
